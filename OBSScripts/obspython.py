...
class gs_device_loss(_object):
    ...
    if _newclass:
        device_loss_release = _swig_property(_obspython.gs_device_loss_device_loss_release_get,
    ...
    if _newclass:
        device_loss_rebuild = _swig_property(_obspython.gs_device_loss_device_loss_rebuild_get,
...
class gs_monitor_info(_object):
    ...
    if _newclass:
        rotation_degrees = _swig_property(_obspython.gs_monitor_info_rotation_degrees_get,
...
class gs_sampler_info(_object):
    ...
    if _newclass:
        max_anisotropy = _swig_property(_obspython.gs_sampler_info_max_anisotropy_get,
    ...
    if _newclass:
        border_color = _swig_property(_obspython.gs_sampler_info_border_color_get,
...
class gs_init_data(_object):
    ...
    if _newclass:
        num_backbuffers = _swig_property(_obspython.gs_init_data_num_backbuffers_get,
...
class obs_key_event(_object):
    ...
    if _newclass:
        native_modifiers = _swig_property(_obspython.obs_key_event_native_modifiers_get,
    ...
    if _newclass:
        native_scancode = _swig_property(_obspython.obs_key_event_native_scancode_get,
...
class obs_key_combination(_object):
    ...
    if _newclass:
        modifiers = _swig_property(_obspython.obs_key_combination_modifiers_get,
...
class obs_transform_info(_object):
    ...
    if _newclass:
        alignment = _swig_property(_obspython.obs_transform_info_alignment_get,
    ...
    if _newclass:
        bounds_type = _swig_property(_obspython.obs_transform_info_bounds_type_get,
    ...
    if _newclass:
        bounds_alignment = _swig_property(_obspython.obs_transform_info_bounds_alignment_get,
...
class obs_video_info(_object):
    ...
    if _newclass:
        base_height = _swig_property(_obspython.obs_video_info_base_height_get,
    ...
    if _newclass:
        output_width = _swig_property(_obspython.obs_video_info_output_width_get,
    ...
    if _newclass:
        output_height = _swig_property(_obspython.obs_video_info_output_height_get,
    ...
    if _newclass:
        output_format = _swig_property(_obspython.obs_video_info_output_format_get,
    ...
    if _newclass:
        gpu_conversion = _swig_property(_obspython.obs_video_info_gpu_conversion_get,
...
class obs_audio_info(_object):
    ...
    if _newclass:
        samples_per_sec = _swig_property(_obspython.obs_audio_info_samples_per_sec_get,
...
class obs_source_audio(_object):
    ...
    if _newclass:
        samples_per_sec = _swig_property(_obspython.obs_source_audio_samples_per_sec_get,
...
class obs_source_cea_708(_object):
    ...
    if _newclass:
        timestamp = _swig_property(_obspython.obs_source_cea_708_timestamp_get,
...
class obs_source_frame(_object):
    ...
    if _newclass:
        color_matrix = _swig_property(_obspython.obs_source_frame_color_matrix_get,
    ...
    if _newclass:
        full_range = _swig_property(_obspython.obs_source_frame_full_range_get,
    ...
    if _newclass:
        color_range_min = _swig_property(_obspython.obs_source_frame_color_range_min_get,
    ...
    if _newclass:
        color_range_max = _swig_property(_obspython.obs_source_frame_color_range_max_get,
    ...
    if _newclass:
        prev_frame = _swig_property(_obspython.obs_source_frame_prev_frame_get,
...
class obs_source_frame2(_object):
    ...
    if _newclass:
        timestamp = _swig_property(_obspython.obs_source_frame2_timestamp_get,
    ...
    if _newclass:
        color_matrix = _swig_property(_obspython.obs_source_frame2_color_matrix_get,
    ...
    if _newclass:
        color_range_min = _swig_property(_obspython.obs_source_frame2_color_range_min_get,
    ...
    if _newclass:
        color_range_max = _swig_property(_obspython.obs_source_frame2_color_range_max_get,
...
class obs_sceneitem_order_info(_object):
    ...
    if _newclass:
        group = _swig_property(_obspython.obs_sceneitem_order_info_group_get,
    ...
    if _newclass:
        item = _swig_property(_obspython.obs_sceneitem_order_info_item_get,
...
class os_proc_memory_usage(_object):
    ...
    if _newclass:
        resident_size = _swig_property(_obspython.os_proc_memory_usage_resident_size_get,
    ...
    if _newclass:
        virtual_size = _swig_property(_obspython.os_proc_memory_usage_virtual_size_get,
...
def obs_enum_sources() -> list:
    return _obspython.obs_enum_sources()


def source_list_release(sources) -> "void":
    return _obspython.source_list_release(sources)


def obs_properties_add_button(props, type, text, func):
    return _obspython.obs_properties_add_button(props, type, text, func)
